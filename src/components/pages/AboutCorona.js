  ...
  return (
    ...
    >
      ...
      <div className="section">
        <div className="section__information">
          <div className="section__paragraph">
            COVID-19 symptoms include cough, fever, shortness of breath, muscle
            aches, sore throat, unexplained loss of taste or smell, diarrhea and
            headache. COVID-19 can be severe, and some cases have caused death
          </div>
        </div>
        <br></br>
      </div>
